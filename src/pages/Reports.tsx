  ...
  return (
    <div className="animate-fade-in" style={styles.container}>
      <header style={styles.header}>
        ...
        <p style={styles.subtitle}>Review cost centers, depreciation matrices, and audit compliance graphs.</p>
      </header>
      ...
      <div style={styles.grid}>
        <div className="glass-panel" style={styles.card}>
          ...
          <p style={styles.paragraph}>
            This module generates audit reconciliations, category depreciation sheets, cost tracking dashboards, 
            and lifecycle cost logs to provide operational insights.
          </p>
