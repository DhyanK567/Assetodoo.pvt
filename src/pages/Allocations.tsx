  ...
  return (
    <div className="animate-fade-in" style={styles.container}>
      <header style={styles.header}>
        <h1 className="gradient-text" style={styles.title}>Asset Allocations</h1>
        <p style={styles.subtitle}>Track active assignments, custodian history, and return schedules.</p>
      </header>
      ...
      <div style={styles.grid}>
        <div className="glass-panel" style={styles.card}>
          ...
          <p style={styles.paragraph}>
            This module links physical assets to custodians (employees or departments). It manages check-out dates, 
            expected return schedules, signed agreements, and provides a timeline of possession histories.
          </p>
