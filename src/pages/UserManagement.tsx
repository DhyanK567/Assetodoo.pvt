  ...
  return (
    <div className="animate-fade-in" style={styles.container}>
      <header style={styles.header}>
        <h1 className="gradient-text" style={styles.title}>User Management</h1>
        <p style={styles.subtitle}>Configure user roles, permission limits, and department alignments.</p>
      </header>
      ...
      <div style={styles.grid}>
        <div className="glass-panel" style={styles.card}>
          ...
          <p style={styles.paragraph}>
            This module registers system accounts, configures roles, and binds users to departments. 
            Only system administrators have permission to alter database permissions here.
          </p>
          <div style={styles.roleBox}>
            <strong>Authorized Roles:</strong> Admin.
          </div>
        </div>
