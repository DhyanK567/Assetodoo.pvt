  ...
  return (
    <div className="animate-fade-in" style={styles.container}>
      <header style={styles.header}>
        <h1 className="gradient-text" style={styles.title}>Asset Maintenance</h1>
        <p style={styles.subtitle}>Report defects, coordinate scheduled calibrations, and track logs.</p>
      </header>
      ...
      <div style={styles.grid}>
        <div className="glass-panel" style={styles.card}>
          ...
          <p style={styles.paragraph}>
            This module schedules inspections, repairs, calibrations, and tracks service ticket operations. 
            Employees can report issues with their assigned hardware, and engineers can update resolution outcomes.
          </p>
          <div style={styles.roleBox}>
            <strong>Authorized Roles:</strong> Admin, Asset Manager, Employee.
          </div>
        </div>
