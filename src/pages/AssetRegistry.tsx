  ...
  return (
    <div className="animate-fade-in" style={styles.container}>
      <header style={styles.header}>
        ...
        <p style={styles.subtitle}>Manage catalog registry, hardware inventory, and serial mappings.</p>
      </header>
      ...
      <div style={styles.grid}>
        <div className="glass-panel" style={styles.card}>
          ...
          <p style={styles.paragraph}>
            This module manages the list of all registered physical and digital assets in the company. 
            It contains fields for asset codes, serial numbers, manufacturers, acquisition dates, status, 
            and depreciated valuations.
          </p>
          <div style={styles.roleBox}>
            <strong>Authorized Roles:</strong> Admin, Asset Manager, Department Head.
          </div>
        </div>
