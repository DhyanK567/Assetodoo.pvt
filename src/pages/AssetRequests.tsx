  ...
  return (
    <div className="animate-fade-in" style={styles.container}>
      <header style={styles.header}>
        <h1 className="gradient-text" style={styles.title}>Asset Requests</h1>
        <p style={styles.subtitle}>Request new hardware allocations, track status, and manage approvals.</p>
      </header>
      ...
      <div style={styles.grid}>
        <div className="glass-panel" style={styles.card}>
          ...
          <p style={styles.paragraph}>
            This module supports employee requisitions for new equipment, department manager approvals, 
            and inventory processing. It handles procurement pipelines and status changes (e.g. Requested, Approved, Procurement, Fulfilled).
          </p>
          <div style={styles.roleBox}>
            <strong>Authorized Roles:</strong> Admin, Asset Manager, Department Head, Employee.
          </div>
        </div>
