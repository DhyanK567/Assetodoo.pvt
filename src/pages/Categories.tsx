  ...
  return (
    <div className="animate-fade-in" style={styles.container}>
      <header style={styles.header}>
        <h1 className="gradient-text" style={styles.title}>Asset Categories</h1>
        <p style={styles.subtitle}>Define structure hierarchies, depreciation policies, and category rules.</p>
      </header>
      ...
      <div style={styles.grid}>
        <div className="glass-panel" style={styles.card}>
          ...
          <p style={styles.paragraph}>
            This module organizes assets into logical categories (e.g. IT Equipment, Office Furniture, Vehicles) 
            and allows configuring default parameters like useful life, depreciation model (e.g. straight line), 
