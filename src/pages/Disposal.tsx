  ...
  return (
    <div className="animate-fade-in" style={styles.container}>
      <header style={styles.header}>
        <h1 className="gradient-text" style={styles.title}>Asset Disposal</h1>
        <p style={styles.subtitle}>Process depreciated decommissioning, write-offs, and salvage logging.</p>
      </header>
      ...
      <div style={styles.grid}>
        <div className="glass-panel" style={styles.card}>
          ...
          <p style={styles.paragraph}>
            This module registers disposals (e.g. Scrapped, Sold, Donated, Lost) and tracks salvage earnings, 
            losses on disposal, and environmental recycling certificate bindings.
          </p>
